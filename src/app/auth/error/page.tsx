  ...
  return (
    <div className="min-h-screen bg-[#ededed] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        {/* Title */}
        <h1 className="font-heading text-[32px] text-[#1b1b1b] mb-4">ERROR DE AUTENTICACIÓN</h1>
...
async function ErrorMessage({ searchParams }: { searchParams: Promise<{ message?: string }> }) {
  ...
  const message =
    params.message || 'Hubo un error al procesar tu solicitud. Por favor, intenta nuevamente.';

  return <p className="font-body text-[16px] text-gray-600 mb-8">{message}</p>;
}
